          ...
          <div className="w-full lg:w-1/2 lg:px-24 md:px-16 ">
            <div className="flex flex-col md:items-start md:text-left items-center text-center mx-auto">
              ...
              <div className="flex justify-center">
                <button className="inline-flex text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-white hover:text-primary-dark rounded-[20px] text-lg uppercase">Learn More &gt;</button>
              </div>
            </div>
          </div>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            ...
            <p className="font-dmsans lg:w-2/3 mx-auto leading-relaxed text-lg">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
            </p>
          </div>
          <div className="flex flex-wrap -m-4">
            <div className="p-4 lg:w-1/3 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <Image alt="team" width={288} height={268} className="services-img flex-shrink-0 rounded-[96px] w-full h-56 !border-solid !border-8 !border-primary object-cover object-center" src="/assets/img/500x500.png" />
                <div className="w-full mt-6">
                  <h3 className="font-rubik font-bold text-5xl text-primary-dark mb-3">Service 1</h3>
                  <p className="font-dmsans mb-4 text-lg px-20"> consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.  deserunt mollit anim id est laborum.</p>
            ...
            <div className="p-4 lg:w-1/3 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <Image alt="team" width={288} height={268} className="services-img flex-shrink-0 rounded-[96px] w-full h-56 !border-solid !border-8 !border-primary object-cover object-center" src="/assets/img/500x500.png" />
                <div className="w-full mt-6">
                  <h3 className="font-rubik font-bold text-5xl text-primary-dark mb-3">Service 2</h3>
                  <p className="font-dmsans mb-4 text-lg px-20"> consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.  deserunt mollit anim id est laborum.</p>
                  <span className="inline-flex">
                    <a className="text-gray-500">
                      <svg fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
            ...
            <div className="p-4 lg:w-1/3 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <Image alt="team" width={288} height={268} className="services-img flex-shrink-0 rounded-[96px] w-full h-56 !border-solid !border-8 !border-primary object-cover object-center" src="/assets/img/500x500.png" />
                <div className="w-full mt-6">
                  <h3 className="font-rubik font-bold text-5xl text-primary-dark mb-3">Service 3</h3>
                  <p className="font-dmsans mb-4 text-lg px-20"> consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.  deserunt mollit anim id est laborum.</p>
                  <span className="inline-flex">
                    <a className="text-gray-500">
                      <svg fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
